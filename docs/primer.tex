...
\subsection{Select-SWAP qROM}

\begin{figure}[ht!]
 \centering
 \includegraphics[scale=1.3]{images/select-swap-lambda-1}
 \caption{A select-SWAP qROM with 4 address bits and tradeoff parameter 1.}
 \end{figure}

\begin{figure}[ht!]
 \centering
 \includegraphics[scale=1.3]{images/select-swap-lambda-2}
 \caption{A select-SWAP qROM with 4 address bits and tradeoff parameter 2.}
 \end{figure}
 
\begin{figure}[ht!]
 \centering
 \includegraphics[scale=1.3]{images/select-swap-lambda-3}
 \caption{A select-SWAP qROM with 4 address bits and tradeoff parameter 3.}
 \end{figure}
